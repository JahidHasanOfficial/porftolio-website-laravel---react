        ...
        <AdminLayout title="System Settings">
            <div className="space-y-6 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-slate-200 dark:border-slate-800">
                    <div>
                        <h1 className="text-xl font-bold text-slate-900 dark:text-white">Website & System Configuration</h1>
                        <p className="text-xs text-slate-500">Manage profile identity, social handles, SEO meta data, and branding assets</p>
                    </div>
