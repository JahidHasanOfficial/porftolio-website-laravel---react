        ...
        <AdminLayout title="Blog Posts">
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <p className="text-sm text-slate-500">Create, review, and edit articles.</p>
                    <Link
                    ...
                    >
                        <Plus className="h-4.5 w-4.5" /> Create Post
                    </Link>
                </div>
                    ...
                    {blogs.data.length > 0 ? (
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm border-collapse">
                                <thead>
                                    <tr className="bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-805 text-slate-500 font-semibold">
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {blogs.data.map((blog) => (
                                        <tr key={blog.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-850/50 transition-colors">
                                            <td className="p-4 font-bold text-slate-805 dark:text-slate-150">
                                                <div className="max-w-xs sm:max-w-sm truncate">{blog.title}</div>
                                            </td>
                                            <td className="p-4">
